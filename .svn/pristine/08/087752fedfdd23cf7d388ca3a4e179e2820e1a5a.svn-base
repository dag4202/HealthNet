...
from main_patient.forms import UserForm, PatientProfileForm, DoctorProfileForm, NurseProfileForm, AdminForm
from django.utils import timezone
from django.core.exceptions import ObjectDoesNotExist
import logging
import csv
from main_patient.models import Document
from main_patient.forms import DocumentForm
...
def RegisterDoctor(request):
	...
	if request.method == 'POST':
		...
		if user_form.is_valid() and doctor_form.is_valid():
			...
			profile = doctor_form.save(commit = True)
			profile.user = user
			profile.save()
...
def RegisterNurse(request):
	...
	if request.method == 'POST':
		...
		if user_form.is_valid() and nurse_form.is_valid():
			...
			profile = nurse_form.save(commit = True)
			profile.user = user
			profile.save()
